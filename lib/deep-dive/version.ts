...
/** The version current code produces. major 2 = ▶ section timestamps. minor 1 = timestamp trailing the heading + first-sentence gold + Print button. minor 2 = H3 subsection timestamps. minor 3 = summary↔deep-dive nav controls. */
export const CURRENT_DEEP_DIVE_VERSION: DeepDiveVersion = { major: 2, minor: 3 };
